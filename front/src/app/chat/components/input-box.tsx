...
export function InputBox({
  ...
  return (
    <div
      className={cn(
        "agentic-input-container relative flex h-full w-full flex-col",
        className,
      )}
      ref={containerRef}
    >
        ...
        <div className="flex shrink-0 items-center gap-2">
          <Tooltip title="Enhance prompt with AI">
            <Button
              ...
              size="icon"
              className={cn(
                "h-10 w-10 border-gradient-to-r from-blue-400 to-purple-500",
                isEnhancing && "animate-pulse shadow-lg",
              )}
            ...
            >
              {isEnhancing ? (
                <div className="flex h-10 w-10 items-center justify-center">
                  <div className="h-3 w-3 animate-bounce rounded-full bg-gradient-to-r from-blue-500 to-purple-600" />
                </div>
              ) : (
                <MagicWandIcon className="text-blue-600 dark:text-blue-400" />
              )}
            </Button>
          </Tooltip>
